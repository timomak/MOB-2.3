# MOB 2.3 Timo's notes! - Concurrency & Parallelism in iOS
[Github Link](https://github.com/Make-School-Courses/MOB-2.3-Concurrency-Parallelism-in-iOS)
...
| Class |          Date          |                 Topics                  |
|:-----:|:----------------------:|:---------------------------------------:|
|  1 |  Tu, May 28                        | [Introduction to Concurrency & Parallelism](class1.md) |
|  2 |  Th, May 30                       | [Grand Central Dispatch](class2.md) |
|  3 |  Tu, June 4                        | [Concurrency & Parallelism - Executing work with GCD]((class3.md)) <br/> **/** <br/> [Interview Practice Problem - Concurrency](Lessons/interview-practice-problem-concurrency) |
|  4 |  Th, June 6                      | [(NS)Operations]((class4.md)) |
|  5 |  Tu, June 11                       | [Xcode Project Management - Schemes, Targets & Build Settings]((class5.md)) |
|  6 |  Th, June 13                      | [Behavior Driven Development]((class6.md)) <br/> **/** <br/> Lesson 8 (TODO) |
